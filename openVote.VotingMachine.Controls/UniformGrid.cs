...
/// <summary>
/// Copy of UniformGrid found here: 
/// https://github.com/rickapps/UWP-UniformGrid-Control/blob/master/UniformGridForUWP/UniformGridForUWP/UniformGrid.cs
/// </summary>
namespace openVote.VotingMachine.Controls
{
	/// <summary>
	...
	public class UniformGrid : Panel
	{
		...
		private static void OnRowsColumnsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
			...
			if (value < 0)
			{
				...
				string message = string.Format(CultureInfo.InvariantCulture, "Properties.Resources.UniformGrid_RowsColumnsChanged_InvalidValue", value);
		...
		protected override Size MeasureOverride(Size constraint)
		{
			...
			Size availableSize = new Size(constraint.Width / _columns, constraint.Height / _rows);
			double num = 0.0;
			double num2 = 0.0;
			int i = 0;
